 ...
 * structures, i.e., linkedlist and arraylist
 * 
 * @author Bobak Hadidi (bhadidi2@illinois.edu)
 * 
 */
public class ObjDataStructs2 extends BaseTestObject {
  ...
  private ArrayList<Character> alist;

  public ObjDataStructs2() {
    ...
    alist.add(new Character('a'));
    alist.add(new Character('b'));
  }

  public static void main(String[] args) {
    original = new ObjDataStructs2();
    if (args.length == 0) {
